...
main (int argc, char *argv[])
{
  ...
  Ptr<Node> consumer = Names::Find<Node> ("sub-1");
  ...
  consumerHelper.SetAttribute ("Ssth", StringValue("8"));
  consumerHelper.SetAttribute ("Window", StringValue("8"));
  consumerHelper.SetAttribute ("Index", StringValue("0"));
  consumerHelper.SetAttribute ("RetxTimer", StringValue("0.3"));
//  consumerHelper.SetAttribute ("PathWindow", StringValue("1"));
  ...
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3RateTracer> > > rateTracers = ndn::L3RateTracer::InstallAll ("tree_depth2_single_rate.txt", Seconds (0.1));

  
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3AggregateTracer> > > aggTracers = ndn::L3AggregateTracer::InstallAll ("tree_depth2_icp_ls.txt", Seconds (999));
