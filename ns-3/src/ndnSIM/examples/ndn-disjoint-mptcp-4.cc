...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("src/ndnSIM/examples/topologies/topo-disjoint-4.txt");
  topologyReader.Read ();
  ...
  ndn::AppHelper consumerHelper ("ns3::ndn::ConsumerWindowMptcp");
  ...
  consumerHelper.SetAttribute ("PathWindow", StringValue("4"));
  ...
  consumerhelper.SetAttribute ("Frequency", StringValue("0.4"));
  consumerhelper.SetAttribute ("Randomize", StringValue("exponential"));
  consumerhelper.SetAttribute ("Ssth", StringValue("4"));
  ...
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3AggregateTracer> > > aggTracers = ndn::L3AggregateTracer::InstallAll ("disjoint_mptcp_ls.txt", Seconds (499));
