...
//  consumerHelper.SetAttribute ("PathWindow", StringValue("1"));
  ...
  //boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3AggregateTracer> > > aggTracers = ndn::L3AggregateTracer::InstallAll ("tree_single_ls.txt", Seconds (999));
