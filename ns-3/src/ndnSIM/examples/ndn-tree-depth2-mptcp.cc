...
main (int argc, char *argv[])
{
  ...
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3AggregateTracer> > > aggTracers = ndn::L3AggregateTracer::InstallAll ("tree_depth2_mptcp_ls.txt", Seconds (999));

  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3RateTracer> > > rateTracers = ndn::L3RateTracer::InstallAll ("tree_depth2_mptcp_rate.txt", Seconds (0.1));
